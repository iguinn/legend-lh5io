...
To start developing *legend-lh5io*, fork the remote repository to your personal
...
All extra tools needed to develop *legend-lh5io* are listed as optional
...
* The *legend-lh5io* test suite is available below ``tests/``. We use `pytest
...
* Additionally, pull request authors are required to provide tests with
  ...
  `codecov.io <https://app.codecov.io/gh/legend-exp/legend-lh5io>`_ to keep track of
...
We adopt best practices in writing and maintaining *legend-lh5io*'s
...
* Documentation should be exclusively available on the Project website
  `legend-lh5io.readthedocs.io <https://legend-lh5io.readthedocs.io>`_. No READMEs,
...
* Documentation for functions, classes, modules and packages should be provided
  ...
  *legend-lh5io* package API documentation.
...
web browser. Documentation for the :mod:`legend-lh5io` website is built and deployed by
`Read the Docs <https://readthedocs.org/projects/legend-lh5io>`_.
...
* To upload the release to the `Python Package Index
  <https://pypi.org/project/legend-lh5io>`_, a new release must be created through
  `the GitHub interface <https://github.com/legend-exp/legend-lh5io/releases/new>`_,
